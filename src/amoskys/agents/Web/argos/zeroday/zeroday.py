...
from amoskys.agents.Web.argos.zeroday.polyglot import Polyglot, polyglots_for_context
...
class ZeroDayReport:
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            "polyglot_candidates": {
                k: [p.to_dict() for p in v] for k, v in self.polyglot_candidates.items()
            },
            "errors": self.errors,
        }
...
def hunt(
    plugin_slug: str, old_version: str, new_version: str, corpus=None
) -> ZeroDayReport:
