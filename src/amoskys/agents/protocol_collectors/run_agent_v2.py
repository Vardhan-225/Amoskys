#!/usr/bin/env python3
"""Launcher for ProtocolCollectorsV2 — Mac Lab & Production.
...
def main() -> None:
    ...
    parser.add_argument("--log-path", default="/var/log/syslog",
                        help="Path to network/protocol log")
    ...
    logging.getLogger(__name__).info(
        "ProtocolCollectorsV2 starting — device=%s interval=%.0fs",
