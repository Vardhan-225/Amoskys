...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in messaging_schema_pb2_grpc.py depends on'
...
def add_EventBusServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'messaging.EventBus', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('messaging.EventBus', rpc_method_handlers)
