"""Tests for FlowAgentV2 and network flow monitoring.

Covers:
    - FlowAgentV2 initialization and probe setup
...
from amoskys.agents.flow.flow_agent import FlowAgentV2, MacOSFlowCollector
...
@pytest.fixture
def flow_agent():
    """Create FlowAgentV2 instance for testing."""
    return FlowAgentV2()


@pytest.fixture
def flow_agent_with_mocks(tmp_path):
    """Create FlowAgentV2 with mocked EventBus and queue."""
...
class TestFlowAgentV2Init:
    """Test FlowAgentV2 initialization."""
...
class TestFlowAgentV2Setup:
    """Test FlowAgentV2 setup and initialization."""
...
class TestFlowAgentV2Collection:
...
class TestFlowAgentV2MacOSCollector:
...
class TestFlowAgentV2Validation:
...
class TestFlowEventBusPublisher:
    """Test EventBusPublisher in flow_agent_v2 module."""
...
# ---------------------------------------------------------------------------
# FlowAgentV2 Setup Extended Tests
# ---------------------------------------------------------------------------


class TestFlowAgentV2SetupExtended:
...
# ---------------------------------------------------------------------------
# FlowAgentV2 collect_data Extended Tests
# ---------------------------------------------------------------------------


class TestFlowAgentV2CollectExtended:
...
# ---------------------------------------------------------------------------
# FlowAgentV2 validate_event Extended Tests
# ---------------------------------------------------------------------------


class TestFlowAgentV2ValidateExtended:
...
# ---------------------------------------------------------------------------
# FlowAgentV2 enrich_event Extended Tests
# ---------------------------------------------------------------------------


class TestFlowAgentV2EnrichExtended:
...
# ---------------------------------------------------------------------------
# FlowAgentV2 Shutdown Tests
# ---------------------------------------------------------------------------


class TestFlowAgentV2Shutdown:
...
# ---------------------------------------------------------------------------
# FlowAgentV2 get_health Tests
# ---------------------------------------------------------------------------


class TestFlowAgentV2GetHealth:
...
# ---------------------------------------------------------------------------
# FlowAgentV2 collect_data with probe events conversion
# ---------------------------------------------------------------------------


class TestFlowAgentV2SecurityEventConversion:
