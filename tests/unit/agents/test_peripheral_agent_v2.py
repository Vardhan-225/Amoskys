"""Tests for PeripheralAgentV2 and peripheral device monitoring.

Covers:
    - PeripheralAgentV2 initialization and probe setup
...
from amoskys.agents.peripheral.peripheral_agent import (
    PeripheralAgent as PeripheralAgentV2,
)

# ---------------------------------------------------------------------------
# PeripheralAgentV2 Tests
# ---------------------------------------------------------------------------


@pytest.fixture
def peripheral_agent():
    """Create PeripheralAgentV2 instance for testing."""
    return PeripheralAgentV2()


@pytest.fixture
def peripheral_agent_with_mocks(tmp_path):
    """Create PeripheralAgentV2 with mocked EventBus and queue."""
    with patch(
        "amoskys.agents.peripheral.peripheral_agent.EventBusPublisher"
    ) as mock_pub_class:
        with patch(
            "amoskys.agents.peripheral.peripheral_agent.LocalQueueAdapter"
        ) as mock_queue_class:
            mock_pub = MagicMock()
...
class TestPeripheralAgentV2Init:
    """Test PeripheralAgentV2 initialization."""
    ...
    def test_custom_collection_interval(self):
        ...
        agent = PeripheralAgentV2(collection_interval=5.0)
        assert agent.collection_interval == 5.0


class TestPeripheralAgentV2Setup:
    """Test PeripheralAgentV2 setup and initialization."""
...
class TestPeripheralAgentV2Collection:
...
class TestPeripheralAgentV2Health:
...
class TestPeripheralAgentV2Validation:
...
class TestPeripheralAgentV2DeviceTracking:
...
class TestPeripheralEventBusPublisher:
    """Test EventBusPublisher in peripheral_agent_v2 module."""

    def test_publisher_init(self):
        """Test EventBusPublisher initialization."""
        from amoskys.agents.peripheral.peripheral_agent_v2 import EventBusPublisher
    ...
    def test_ensure_channel_generic_error(self, tmp_path):
        ...
        with patch(
            "amoskys.agents.peripheral.peripheral_agent.grpc.ssl_channel_credentials",
...
# ---------------------------------------------------------------------------
# PeripheralAgentV2 Setup Extended Tests
# ---------------------------------------------------------------------------


class TestPeripheralAgentV2SetupExtended:
...
# ---------------------------------------------------------------------------
# PeripheralAgentV2 collect_data Extended Tests
# ---------------------------------------------------------------------------


class TestPeripheralAgentV2CollectExtended:
...
# ---------------------------------------------------------------------------
# PeripheralAgentV2 validate_event Extended Tests
# ---------------------------------------------------------------------------


class TestPeripheralAgentV2ValidateExtended:
...
# ---------------------------------------------------------------------------
# PeripheralAgentV2 Shutdown Tests
# ---------------------------------------------------------------------------


class TestPeripheralAgentV2Shutdown:
...
# ---------------------------------------------------------------------------
# PeripheralAgentV2 get_health Tests
# ---------------------------------------------------------------------------


class TestPeripheralAgentV2GetHealth:
