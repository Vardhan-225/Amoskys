"""Extended unit tests for DNSAgentV2 — targeting uncovered lines.

The existing test_dns_agent_v2.py covers initialization, basic setup, stub probes,
...
- DNSAgentV2.collect_data (full pipeline with probes producing security events)
- DNSAgentV2.validate_event (all error branches)
- DNSAgentV2.shutdown
- DNSAgentV2.get_health
- DNSAgentV2.setup (certificate warnings, setup_probes failure branch)
"""
...
class TestGetDNSCollector:
    ...
    @patch("amoskys.agents.dns.dns_agent.platform")
...
# =============================================================================
# DNSAgentV2.validate_event - all branches
# =============================================================================
...
# =============================================================================
# DNSAgentV2.collect_data - full pipeline
# =============================================================================
