"""Unit tests for ProtocolCollectors agent and protocol collector components.
...
Tests cover:
    ...
    - ProtocolCollectors agent initialization, setup, collect_data cycle
...
from amoskys.agents.protocol_collectors.protocol_collectors import (
    ProtocolCollectors,
...
class TestDNSTunnelingProbe:
    ...
    def test_long_subdomain_detected(self):
        ...
        probe = DNSTunnelingProbe()
        long_subdomain = "a" * 55  # > MAX_NORMAL_SUBDOMAIN_LENGTH (50)
        context = _make_context(
            [
                _make_protocol_event(
                    protocol=ProtocolType.DNS,
...
# =============================================================================
# Test: ProtocolCollectors Agent Initialization
# =============================================================================


class TestProtocolCollectorsInit:
...
# =============================================================================
# Test: ProtocolCollectors Setup
# =============================================================================


class TestProtocolCollectorsSetup:
    ...
    def test_setup_returns_true(self):
        ...
        agent = ProtocolCollectors(device_id="host-001", use_stub=True)
        assert agent.setup() is True


# =============================================================================
# Test: ProtocolCollectors Data Collection
# =============================================================================


class TestProtocolCollectorsCollection:
...
# =============================================================================
# Test: ProtocolCollectors Cleanup
# =============================================================================


class TestProtocolCollectorsCleanup:
    """Test agent cleanup."""
...
# =============================================================================
# Test: ProtocolCollectors Health
# =============================================================================


class TestProtocolCollectorsHealth:
...
# =============================================================================
# Test: ProtocolCollectors Probe Error Isolation
# =============================================================================


class TestProtocolCollectorsProbeIsolation:
...
class TestCreateProtocolCollectors:
    """Test convenience factory function."""

    def test_creates_agent(self):
        """Factory creates ProtocolCollectors instance."""
        agent = create_protocol_collectors(device_id="host-001")
        assert isinstance(agent, ProtocolCollectors)
        assert agent.device_id == "host-001"
...
class TestEdgeCases:
    ...
    def test_concurrent_agent_instances(self):
        ...
        agent1 = ProtocolCollectors(device_id="host-001", use_stub=True)
        agent2 = ProtocolCollectors(device_id="host-002", use_stub=True)
        agent1.setup()
        agent2.setup()
...
__all__ = [
    ...
    "TestProtocolCollectorsInit",
    "TestProtocolCollectorsSetup",
    "TestProtocolCollectorsCollection",
    "TestProtocolCollectorsCleanup",
    "TestProtocolCollectorsHealth",
    "TestProtocolCollectorsProbeIsolation",
    "TestCreateProtocolCollectors",
