...
def _calculate_health_score(agents_online: int, agents_total: int, 
                            infrastructure_ok: bool, events_24h: int) -> int:
...
def system_health():
    ...
    return jsonify({
        ...
        "agents_summary": {
            ...
            "total": agents_total,
            "coverage_percent": round((agents_online / max(agents_total, 1)) * 100, 1),
        },
        ...
        "health_status": (
            ...
            else "degraded" if health_score >= 40
            else "critical"
        ),
