...
def onboarding_catalog():
    ...
    bundles = {
        ...
        "advanced": {
            ...
            "agents": [
                "proc", "auth", "persistence", "fim", "flow",
                "dns", "http_inspector", "applog", "peripheral",
            ],
            "icon": "zap",
        },
        "full": {
...
def onboarding_bootstrap():
    ...
    script = script.replace("        # AMOSKYS Agent Configuration", "# AMOSKYS Agent Configuration")
    script = script.replace("        # Generated by setup wizard", "# Generated by setup wizard")
