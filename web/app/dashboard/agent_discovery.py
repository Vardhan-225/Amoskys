...
AGENT_CATALOG = {
    ...
    "proc_agent": {
        ...
        "process_patterns": ["amoskys.agents.proc", "proc_agent", "ProcAgent"],
    ...
    "dns_agent": {
        ...
        "path": "src/amoskys/agents/dns/dns_agent.py",
        "process_patterns": ["amoskys.agents.dns", "dns_agent", "DNSAgent"],
        "protocol": "LocalQueue → EventBus",
    ...
    "auth_agent": {
        ...
        "path": "src/amoskys/agents/auth/auth_guard_agent.py",
        "process_patterns": [
            "amoskys.agents.auth",
            "auth_guard_agent",
            "AuthGuardAgent",
    ...
    "fim_agent": {
        ...
        "path": "src/amoskys/agents/fim/fim_agent.py",
        "process_patterns": ["amoskys.agents.fim", "fim_agent", "FIMAgent"],
        "protocol": "LocalQueue → EventBus",
    ...
    "flow_agent": {
        ...
        "path": "src/amoskys/agents/flow/flow_agent.py",
        "process_patterns": ["amoskys.agents.flow", "flow_agent", "FlowAgent"],
        "protocol": "LocalQueue → EventBus",
    ...
    "persistence_agent": {
        ...
        "type": "Collector",
        "module": "amoskys.agents.persistence",
        "port": None,
        "platform": ["darwin", "linux"],
        "capabilities": [
        ...
        "path": "src/amoskys/agents/persistence/persistence_agent.py",
        "process_patterns": [
            "amoskys.agents.persistence",
            "persistence_agent",
            "PersistenceGuard",
        ],
        "protocol": "LocalQueue → EventBus",
    ...
    "peripheral_agent": {
        ...
        "type": "Collector",
        "module": "amoskys.agents.peripheral",
        "port": None,
        "platform": ["darwin", "linux"],
        "capabilities": [
            "usb-monitoring",
    ...
    "kernel_audit_agent": {
        ...
        "type": "Collector",
        "module": "amoskys.agents.kernel_audit",
        "port": None,
        "platform": ["darwin", "linux"],
        "capabilities": [
            "syscall-monitoring",
        ...
        "path": "src/amoskys/agents/kernel_audit/kernel_audit_agent.py",
        "process_patterns": [
            "amoskys.agents.kernel_audit",
            "kernel_audit_agent",
            "KernelAuditAgent",
        ],
        "protocol": "LocalQueue → EventBus",
    ...
    "device_discovery_agent": {
        ...
        "type": "Discovery",
        "module": "amoskys.agents.device_discovery.run_agent_v2",
        "port": None,
        "platform": ["darwin", "linux"],
        "capabilities": [
            "arp-enumeration",
        ...
        "path": "src/amoskys/agents/device_discovery/run_agent.py",
        "process_patterns": [
            "amoskys.agents.device_discovery",
            "device_discovery",
            "device_scanner",
        ],
        "protocol": "LocalQueue → EventBus",
    ...
    "protocol_collectors_agent": {
        ...
        "type": "Collector",
        "module": "amoskys.agents.protocol_collectors.run_agent_v2",
        "port": None,
        "platform": ["darwin", "linux"],
        "capabilities": [
        ...
        "path": "src/amoskys/agents/protocol_collectors/run_agent.py",
        "process_patterns": [
    ...
    "applog_agent": {
        ...
        "path": "src/amoskys/agents/applog/applog_agent.py",
        "process_patterns": [
            "amoskys.agents.applog",
            "applog_agent",
            "AppLogAgent",
        ],
        "protocol": "LocalQueue → EventBus",
    ...
    "db_activity_agent": {
        ...
        "type": "Collector",
        "module": "amoskys.agents.db_activity",
        "port": None,
        "platform": ["darwin", "linux"],
        "capabilities": [
        ...
        "path": "src/amoskys/agents/db_activity/db_activity_agent.py",
        "process_patterns": [
            "amoskys.agents.db_activity",
            "db_activity_agent",
            "DBActivityAgent",
        ],
        "protocol": "LocalQueue → EventBus",
    ...
    "http_inspector_agent": {
        ...
        "type": "Collector",
        "module": "amoskys.agents.http_inspector",
        "port": None,
        "platform": ["darwin", "linux"],
        "capabilities": [
            "xss-detection",
        ...
        "path": "src/amoskys/agents/http_inspector/http_inspector_agent.py",
        "process_patterns": [
            "amoskys.agents.http_inspector",
            "http_inspector_agent",
            "HTTPInspectorAgent",
        ],
        "protocol": "LocalQueue → EventBus",
    ...
    "internet_activity_agent": {
        ...
        "type": "Collector",
        "module": "amoskys.agents.internet_activity",
        "port": None,
        "platform": ["darwin", "linux"],
        "capabilities": [
        ...
        "path": "src/amoskys/agents/internet_activity/internet_activity_agent.py",
        "process_patterns": [
            "amoskys.agents.internet_activity",
            "internet_activity_agent",
    ...
    "net_scanner_agent": {
        ...
        "type": "Discovery",
        "module": "amoskys.agents.net_scanner",
        "port": None,
        "platform": ["darwin", "linux"],
        "capabilities": [
            "service-detection",
        ...
        "path": "src/amoskys/agents/net_scanner/net_scanner_agent.py",
        "process_patterns": [
            "amoskys.agents.net_scanner",
            "net_scanner_agent",
            "NetScannerAgent",
        ],
        "protocol": "LocalQueue → EventBus",
