#!/usr/bin/env python3
"""Run KernelAuditGuardV2 in dev mode on your local Mac.
...
Usage:
    python3 scripts/dev_kernel_audit.py
"""
...
AGENT_DIR = ROOT / "deployments" / "kernel_audit"

# Local queue path for dev
LOCAL_QUEUES = ROOT / ".local_queues" / "kernel_audit"
LOCAL_QUEUES.mkdir(parents=True, exist_ok=True)


def main():
    """Run KernelAudit agent in dev mode."""
    env = os.environ.copy()
    env["AMOSKYS_ENV"] = "dev"
